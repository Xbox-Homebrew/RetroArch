...
MSG_HASH(
   ...
   "Altere as configurações do controle, teclado e mouse."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Altere as configurações dos atalhos."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Altere as configurações do rebobinamento."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Altere as configurações da aparência da tela do menu."
   )
MSG_HASH(
